...
class DebitTest {
    ...
    @Test fun sans_mesure_le_debit_est_inconnu() {
        ...
        // a un blocage.
        assertNull(Debit().octetsParSeconde())
    }
    ...
    @Test fun deux_mesures_donnent_un_debit() {
        ...
        assertEquals(1000.0, d.octetsParSeconde()!!, 1.0)
    }
    ...
    @Test fun le_temps_restant_se_deduit_du_debit() {
        ...
        assertEquals(5L, d.secondesRestantes(5000))
    }
    ...
    @Test fun un_reste_nul_donne_zero_seconde() {
        ...
        assertEquals(0L, d.secondesRestantes(0))
    }
    ...
    @Test fun un_debit_nul_ne_divise_pas_par_zero() {
        ...
        assertNull(d.secondesRestantes(1000))
    }
}
